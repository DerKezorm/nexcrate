...
/** Ein kurzer Satz unten in der Mitte, der von selbst wieder geht. */
  ...
  return (
    <NoticeContext.Provider value={notify}>
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-6 z-50 flex justify-center px-4" role="status" aria-live="polite">
        {message && (
          <p className="animate-nc-rise flex items-center gap-2 rounded-full border border-accent-500/40 bg-ink-850 px-4 py-2 text-sm text-mist-200 shadow-2xl shadow-black/50">
